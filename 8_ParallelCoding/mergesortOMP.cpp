...
void parse_space_separated_tokens(const std::string &src_filename, std::vector<int64_t>& result)
{
...
void output_sorted(const std::vector<int64_t>& result, int argc, char *argv[])
{
